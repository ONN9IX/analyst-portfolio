...
![Yandex DataLens E-commerce Sales Dashboard](./datalens_dashboard.png)

Готовый dashboard содержит KPI-блок, временную динамику, анализ категорий, регионов, клиентских сегментов, маржинальности и Top Products.
