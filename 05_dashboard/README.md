...
Готовый dashboard состоит из KPI-блока, временной динамики, категорий, регионов, клиентских сегментов, маржинальности и Top Products. Исходные скриншоты сохранены владельцем репозитория; для публикации изображения в GitHub требуется бинарная загрузка файла в `05_dashboard/images/`.
