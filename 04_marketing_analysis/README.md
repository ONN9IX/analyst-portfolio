...
## Задача
Проанализировать эффективность digital-кампаний по данным января 2024 года и рассчитать основные маркетинговые KPI.
...
Источник проекта прямо указывает, что данные извлекались через **Mockaroo**, то есть это **синтетические учебные данные**, имитирующие выгрузку рекламных API. Поэтому результаты рассматриваются как учебный аналитический кейс.
